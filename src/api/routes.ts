 ...
 *         description: Server error
 */
routes.patch('/events/:id', (req, res) => {
 ...
 *         description: Server error
 */
routes.get('/events/:id/releases', (req, res) => {
  try {
 ...
 *         description: Server error
 */
routes.post('/release/attach', (req, res) => {
 ...
 *         description: Server error
 */
routes.delete('/release/attach/:releaseId', (req, res) => {
 ...
 *         description: Server error
 */
routes.patch('/release/attach', (req, res) => {
  const parseResult = AttachReleaseSchema.safeParse(req.body);
  if (!parseResult.success) {
    return res.status(400).json({ error: 'Invalid payload', details: parseResult.error.issues });
  }
 ...
 *         description: Server error
 */
routes.get('/release/validate/id', (req, res) => {
 ...
 *         description: Server error
 */
routes.post('/applications', (req, res) => {
 ...
 *         description: Server error
 */
routes.get('/events/search/', (req, res) => {
